<x-app-layout>
    ...
    <div class="container max-w-6xl mx-auto mt-20">
        <div class="mb-4">
            <h1 class="font-serif text-3xl font-bold underline decoration-gray-400"> Band Index</h1>
                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                                ...
                                <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                    <form action="{{ route('bands.destroy',$band->id) }}" method="POST" onsubmit="return confirm('{{ trans('are You Sure ? ') }}');">
